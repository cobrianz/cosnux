  ...
  const cards = [
    {
      ...
      description: "Tailored applications built to meet your specific business needs.",
      Component: AiCodeReviews,
    },
    {
      title: "Cloud Infrastructure Solutions",
      description: "Scalable, secure cloud platforms for modern businesses.",
        ...
        <div className="self-stretch py-8 md:py-14 flex flex-col justify-center items-center gap-2 z-10">
          <div className="flex flex-col justify-start items-center gap-4">
            ...
            <p className="w-full max-w-[600px] text-center text-muted-foreground text-lg md:text-xl font-medium leading-relaxed">
              From custom software development to cloud infrastructure, we deliver innovative technology solutions that
              drive growth and efficiency for your organization.
            </p>
          </div>
        </div>
