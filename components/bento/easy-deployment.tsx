    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            height: "100%",
            overflow: "hidden",
            fontFamily: "var(--font-jetbrains-mono), 'SF Mono', Monaco, Consolas, 'Liberation Mono', monospace",
            fontSize: "10px",
            lineHeight: "16px",
      ...
      <button
        style={{
          ...
          fontFamily: "var(--font-jost), -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
          fontSize: "16.575px",
          lineHeight: "25.5px",
